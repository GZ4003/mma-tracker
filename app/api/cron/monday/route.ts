...
// vercel.json (Mondays at 23:15 UTC / 8:15pm Argentina time — Hobby plan
// cron jobs have a flexible ~1 hour execution window, so it can land
// anytime up to ~9:15pm). Sends every user a personalized kickoff email
// for the new week.
